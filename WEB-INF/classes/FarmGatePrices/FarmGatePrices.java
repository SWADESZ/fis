...
public class FarmGatePrices {

    static Connection connection;

    public static ResultSet loadFarmGatePrice(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Get record
            int i = 0;
            query = "SELECT * FROM farmgateprices where fid = '" + request.getParameter("fid") + "'";
    ...
    public static void deleteFarmGatePrice(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int added = 0;
            query = "Delete From farmgateprices where fgpid = '" + request.getParameter("fgpid") + "'";
    ...
    public static String getFGPID(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        return request.getParameter("fgpid");
    }

    public static ResultSet getFGPriceID(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/fis", "root", "Makaveli1978");
                ...
                int i = 0;
                query = "";
                query = "Select * From farmgateprices where fgpid = '" + request.getParameter("fgpid") + "'";
                Statement st = connection.createStatement();
    ...
    public static void saveAvailableProduce(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (FarmGatePrices.getUserView3(request, response) != null) {
